...
pub type PiecePieceTo<T> = [[[T; Square::NUM]; Piece::NUM]; Piece::NUM];
...
pub fn new_piece_piece_to_table<T: Copy>(default: T) -> PiecePieceTo<T> {
    [[[default; Square::NUM]; Piece::NUM]; Piece::NUM]
}
