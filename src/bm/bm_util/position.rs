...
pub static mut BASE: i32 = 512;
pub static mut PAWN: i32 = 0;
pub static mut KNIGHT: i32 = 256;
pub static mut BISHOP: i32 = 256;
pub static mut ROOK: i32 = 256;
pub static mut QUEEN: i32 = 256;
pub static mut CLAMP: i16 = 200;
