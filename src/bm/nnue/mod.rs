...
impl Nnue {
    ...
    pub fn reset(&mut self, board: &Board, threats: Threats) {
        ...
        for sq in threats.slider_threats(Color::White) {
            self.update::<true>(threat_indices(w_king, b_king, sq, Color::Black));
        }
        for sq in threats.slider_threats(Color::Black) {
    ...
    pub fn make_move(
        ...
        let w_threats = threats.slider_threats(Color::White);
        let old_w_threats = old_threats.slider_threats(Color::White);
        let b_threats = threats.slider_threats(Color::Black);
        let old_b_threats = old_threats.slider_threats(Color::Black);
