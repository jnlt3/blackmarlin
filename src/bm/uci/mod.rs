    ...
    pub fn new() -> Self {
        ...
        macro_rules! add_param {
            ($name: ident: $value_type: ty = range($min: expr, $max: expr)) => {
                use crate::bm::bm_search::see::$name;
        ...
        add_param!(PAWN: i16 = range(0, 200));
        add_param!(MINOR: i16 = range(0, 600));
        add_param!(ROOK: i16 = range(0, 1000));
        add_param!(QUEEN: i16 = range(0, 2000));
