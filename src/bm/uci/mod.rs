...
impl UciAdapter {
    pub fn new() -> Self {
        ...
        add_param!(D_EXT_MARGIN: i16 = range(1, 100));
        ...
        add_param!(ROOT_LMR_MUL: u32 = range(0, 30));
        add_param!(HIST_BONUS: i16 = range(1, 64));
        add_param!(RAZOR_QS: i16 = range(0, 400));

        add_param!(QS_LOSING: i16 = range(0, 200));
        add_param!(QS_WINNING: i16 = range(0, 500));
        add_param!(QS_NEUTRAL: i16 = range(0, 500));
