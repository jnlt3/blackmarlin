...
fn parse_policy_net() {
    ...
    let perceptron_weights_1 = dense_rev_from_bytes_i8(&nn_bytes, HIDDEN, 4096);
    nn_bytes = &nn_bytes[HIDDEN * 4096..];
    let perceptron_bias_1 = bias_from_bytes_i8(&nn_bytes, 4096);
    ...
    def_layers += &format!(
        "pub const P_WEIGHTS_1: [[i8; {}]; 4096] = {}\n",
        HIDDEN, perceptron_weights_1,
    );
    def_layers += &format!("pub const P_BIAS_1: [i16; 4096] = {}\n", perceptron_bias_1);
